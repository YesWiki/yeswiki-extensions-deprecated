                ...
                if (is_dir($destfolder)) {
                    ...
                    if (is_writable($GLOBALS['wiki']->config['yeswiki-farm-root-folder'])) {
                        ...
                        $config = array (
                              ...
                              'action_path' => $GLOBALS['wiki']->config['action_path'],
                              'handler_path' => $GLOBALS['wiki']->config['handler_path'],
                              'header_action' => $GLOBALS['wiki']->config['header_action'],
                              'footer_action' => $GLOBALS['wiki']->config['footer_action'],
